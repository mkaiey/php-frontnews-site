<footer>
  ...
  <h2 class="brand"><a href="index.php"> Fr<span style="color: #ff591cbb">o</span>nt-NEWS </a></h2>
  ...
  <div class="footer-main-container">
    <div>
      ...
      <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia, quidem. </a> <br>
        ...
        <a href="mailto:mkaidev88@gmail.com">Email: mkaidev88@gmail.com</a>
      </p>
    </div>
    <div>
      <a href="javascript:void(0)" class="sub-container">Useful links</a>
    ...
    <div>
      ...
      <hr>
      <a href="https://mkaidev-mern-portfolio.vercel.app" class="facb"><i class="fa fa-facebook"></i> Facebook</a><br>
      <a href="https://mkaidev-mern-portfolio.vercel.app" class="insg"><i class="fa fa-instagram"></i> Instagram</a><br>
      <a href="https://mkaidev-mern-portfolio.vercel.app" class="twit"><i class="fa fa-twitter"></i> Twitter</a><br>
      <a href="https://mkaidev-mern-portfolio.vercel.app" class="teleg"><i class="fa fa-telegram"></i> Telegram</a><br>
    </div>
    <div>
  ...
  <p class="footer-terms">Copyright &copy; <script>
      document.write(new Date().getFullYear())
    </script> FrontNEWS. All right reserved</p>
</footer>