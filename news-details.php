...
<head>
  ...
  <meta name="description" content="-UPDATED- FrontNEWS is your one-stop media platform that gives you update and keep you updated on trending news, politics, Entertainment, health, sports and so much more.">
  ...
  <meta name="author" content="Frontnews">

  <title>FrontNEWS | News Detail</title>
...
<body>
  ...
  <section class="header-box fixed-bar">
    ...
    <h2 class="brand"><a href="index.php"> Fr<span style="color: red">o</span>nt NEWS </a></h2>
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <div class="main-side-container">
      <div>
        ...
        <a href="category.php?catid=11"> News</a>
      ...
      <div>
        ...
        <hr>
        <a href="https://mkaidev-mern-portfolio.vercel.app" class="facb"><i class="fa fa-facebook"></i> Facebook</a>
        <a href="https://mkaidev-mern-portfolio.vercel.app" class="insg"><i class="fa fa-instagram"></i> Instagram</a>
        <a href="https://mkaidev-mern-portfolio.vercel.app" class="twit"><i class="fa fa-twitter"></i> Twitter</a>
        <a href="https://mkaidev-mern-portfolio.vercel.app" class="teleg"><i class="fa fa-telegram"></i> Telegram</a>
      </div>
      <div>
